...
class _CreateEditTaskScreenState extends State<CreateEditTaskScreen> {
  ...
  Future<void> _initialize() async {
    ...
    if (initialGroupId == null && groups.isNotEmpty) {
      initialGroupId = groups.first['groupId'] as String;
    }
  ...
  Future<void> _save() async {
    ...
    if (_dueDate != null &&
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Hạn chót không được nhỏ hơn ngày bắt đầu'),
        ),
      );
      return;
    }
    ...
    return Scaffold(
      ...
      bottomNavigationBar: SafeArea(
        ...
        child: FilledButton(
          ...
          child: Text(
            _isSaving ? 'Đang lưu...' : (isEdit ? 'Lưu thay đổi' : 'Tạo công việc'),
            style: const TextStyle(
              fontFamily: _bodyFont,
              fontWeight: FontWeight.w700,
            ),
